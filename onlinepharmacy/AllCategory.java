...
import com.example.onlinepharmacy.adapter.AllCategoryAdapter;
import com.example.onlinepharmacy.model.AllCategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(AllCategory.this,LoginActivity.class));
                finish();
            }
        });
